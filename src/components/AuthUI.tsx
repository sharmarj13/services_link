...
export function PrimaryButton({
  ...
  return (
    <button
      ...
      className={`w-full py-3.5 rounded-lg bg-[#D12031] hover:bg-[#a81828] disabled:bg-[#D12031]/70 disabled:cursor-not-allowed text-white font-bold text-[16px] border-none flex items-center justify-center gap-2 font-sans transition-colors duration-150 box-border ${isLoading ? 'cursor-wait' : 'cursor-pointer'}`}
    >
      {isLoading ? (
